...
def frac_to_cartesian(cell, frac_coord, basis,origin_cart):
    ...
    where:
        ...
        - origin is the coordinate system origin (e.g., cif origin)
    Args:
        ...
        origin_cart: Origin offset in Cartesian coordinates, For cif convention, use space_group_origin_cartesian
...
class atomIndex:
    def __init__(self, cell, frac_coord,position_name, basis,origin_cart, parsed_config,
        ...
        Args:
            ...
            origin_cart: Cartesian origin offset (e.g., cif origin)
...
class hopping:
    ...
    def __init__(self, to_atom, from_atom, operation_idx, rotation_matrix, translation_vector, n_vec, is_seed):
        ...
        :param rotation_matrix: 3×3 rotation/reflection matrix R (in Cartesian coordinates, cif origin)
        :param translation_vector: 3D translation vector t from the cif space group operation
...
class vertex():
    ...
    def __init__(self, hopping, type, identity_idx, parent=None):
        ...
        Args:
            ...
            identity_idx: Index of the identity operation in space_group_cif_cart
